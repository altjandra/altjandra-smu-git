        ...
        <div class="container">
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <div class="clearfix">
                        <div class="hint-text">Showing <b>5</b> out of <b>25</b> learners</div>
                        <ul class="pagination">
          ...
          <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" style="background-color: #96BB7C; border-color: #96BB7C;">Confirm Assign</button>
              </div>
              </form>
            </div>
          </div>
